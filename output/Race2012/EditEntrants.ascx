<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="EditEntrants.ascx.vb" Inherits="Crewstone Consulting ltd.Modules.Race2012.EditEntrants" %>
...
<asp:GridView ID="GridEntrants" runat="server" 
    ...
    <Columns>
        ...
        <asp:BoundField DataField="ContactType" HeaderText="ContactType" SortExpression="ContactType" Visible="True" />
        <asp:BoundField DataField="FullName" HeaderText="FullName" SortExpression="FullName" Visible="True" />
        <asp:BoundField DataField="FirstName" HeaderText="FirstName" SortExpression="FirstName" Visible="True" />
        <asp:BoundField DataField="MiddleName" HeaderText="MiddleName" SortExpression="MiddleName" Visible="True" />
        <asp:BoundField DataField="LastName" HeaderText="LastName" SortExpression="LastName" Visible="True" />
        <asp:BoundField DataField="Suffix" HeaderText="Suffix" SortExpression="Suffix" Visible="True" />
        <asp:BoundField DataField="Nickname" HeaderText="Nickname" SortExpression="Nickname" Visible="True" />
        <asp:BoundField DataField="BirthDate" HeaderText="BirthDate" SortExpression="BirthDate" Visible="True" />
        ...
        <asp:BoundField DataField="TShirt" HeaderText="TShirt" SortExpression="TShirt" Visible="True" />
        <asp:BoundField DataField="Sweats" HeaderText="Sweats" SortExpression="Sweats" Visible="True" />
        <asp:BoundField DataField="Shorts" HeaderText="Shorts" SortExpression="Shorts" Visible="True" />
        <asp:BoundField DataField="Shoes" HeaderText="Shoes" SortExpression="Shoes" Visible="True" />
        <asp:BoundField DataField="ShoeStyle" HeaderText="ShoeStyle" SortExpression="ShoeStyle" Visible="True" />
        <asp:BoundField DataField="Club" HeaderText="Club" SortExpression="Club" Visible="True" />
        ...
        <asp:BoundField DataField="ZIP" HeaderText="ZIP" SortExpression="ZIP" Visible="True" />
        <asp:BoundField DataField="Country" HeaderText="Country" SortExpression="Country" Visible="True" />
        <asp:BoundField DataField="HomePhone" HeaderText="HomePhone" SortExpression="HomePhone" Visible="True" />
        <asp:BoundField DataField="MobilePhone" HeaderText="MobilePhone" SortExpression="MobilePhone" Visible="True" />
        <asp:BoundField DataField="MobileCarrier" HeaderText="MobileCarrier" SortExpression="MobileCarrier" Visible="True" />
        <asp:BoundField DataField="EMail" HeaderText="EMail" SortExpression="EMail" Visible="True" />
        <asp:BoundField DataField="PlainText" HeaderText="PlainText" SortExpression="PlainText" Visible="True" />
        ...
        <asp:BoundField DataField="MemberNumber" HeaderText="MemberNumber" SortExpression="MemberNumber" Visible="True" />
        <asp:BoundField DataField="MemberCode" HeaderText="MemberCode" SortExpression="MemberCode" Visible="True" />
        <asp:BoundField DataField="DateJoined" HeaderText="DateJoined" SortExpression="DateJoined" Visible="True" />
        <asp:BoundField DataField="LastRenewal" HeaderText="LastRenewal" SortExpression="LastRenewal" Visible="True" />
        <asp:BoundField DataField="PaidThru" HeaderText="PaidThru" SortExpression="PaidThru" Visible="True" />
        <asp:BoundField DataField="Waiver" HeaderText="Waiver" SortExpression="Waiver" Visible="True" />
        <asp:BoundField DataField="PrimaryNo" HeaderText="PrimaryNo" SortExpression="PrimaryNo" Visible="True" />
        <asp:BoundField DataField="Survivor" HeaderText="Survivor" SortExpression="Survivor" Visible="True" />
        <asp:BoundField DataField="MailingExpiration" HeaderText="MailingExpiration" SortExpression="MailingExpiration" Visible="True" />
        <asp:BoundField DataField="Memo" HeaderText="Memo" SortExpression="Memo" Visible="True" />
        <asp:BoundField DataField="Marked" HeaderText="Marked" SortExpression="Marked" Visible="True" />
        <asp:BoundField DataField="Keywords" HeaderText="Keywords" SortExpression="Keywords" Visible="True" />
        <asp:BoundField DataField="Company" HeaderText="Company" SortExpression="Company" Visible="True" />
        <asp:BoundField DataField="Title" HeaderText="Title" SortExpression="Title" Visible="True" />
        <asp:BoundField DataField="WorkAddress" HeaderText="WorkAddress" SortExpression="WorkAddress" Visible="True" />
        <asp:BoundField DataField="WorkCity" HeaderText="WorkCity" SortExpression="WorkCity" Visible="True" />
        <asp:BoundField DataField="WorkState" HeaderText="WorkState" SortExpression="WorkState" Visible="True" />
        <asp:BoundField DataField="WorkZip" HeaderText="WorkZip" SortExpression="WorkZip" Visible="True" />
        <asp:BoundField DataField="WorkCountry" HeaderText="WorkCountry" SortExpression="WorkCountry" Visible="True" />
        <asp:BoundField DataField="WorkPhone" HeaderText="WorkPhone" SortExpression="WorkPhone" Visible="True" />
        <asp:BoundField DataField="WorkEmail" HeaderText="WorkEmail" SortExpression="WorkEmail" Visible="True" />
        <asp:BoundField DataField="ActiveId" HeaderText="ActiveId" SortExpression="ActiveId" Visible="True" />
        <asp:BoundField DataField="InvalidEmail" HeaderText="InvalidEmail" SortExpression="InvalidEmail" Visible="True" />
        <asp:BoundField DataField="ResultsEmailOnly" HeaderText="ResultsEmailOnly" SortExpression="ResultsEmailOnly" Visible="True" />
        <asp:BoundField DataField="InvalidAddress" HeaderText="InvalidAddress" SortExpression="InvalidAddress" Visible="True" />
        ...
        <asp:BoundField DataField="UpdateDate" HeaderText="UpdateDate" SortExpression="UpdateDate" Visible="True" />
    </Columns>
    <EmptyDataTemplate>
...
<br />
<asp:Button ID="AddEntrantsItemButton" runat="server" EnableViewState="False" Text="Add Entrants"></asp:Button>
<br /><br />
        ...
        <td class="Normal"><asp:TextBox ID="txtUpdateDate" runat="server" Text='<%# Bind("UpdateDate") %>' EnableViewState="False"></asp:TextBox><asp:comparevalidator id="comUpdateDate" CssClass="NormalRed" runat="server" resourcekey="valUpdateDate.ErrorMessage" ControlToValidate="txtUpdateDate" Display="Dynamic" ErrorMessage="Not Date" Type="Date" Operator="DataTypeCheck"></asp:comparevalidator></td>
         ...
         <p>
             <asp:LinkButton ID="InsertEntrantsItemButton" runat="server" 
                 ...
                 Text="Insert" OnClick="InsertEntrantsItemButton_Click">
             </asp:LinkButton>&nbsp;
